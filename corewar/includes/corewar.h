...
int print_info_process(t_vm *vm, SDL_Rect coord, t_process process, int change);
...
int print_process_1(t_process ***process, int *process_num, int *old_mem);
...
t_process_list *init_process_list(t_champ_decoded *champs_decoded, int nb_champs);

/*
** INSTRUCTIONS, please refer to corresponding .c
*/
void live(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void ld(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void st(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void add(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void sub(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void and (t_process * pro, t_arena *ar, t_instr_ret *ret, char verbose);
void or (t_process * pro, t_arena *ar, t_instr_ret *ret, char verbose);
void xor (t_process * pro, t_arena *ar, t_instr_ret *ret, char verbose);
void zjmp(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void ldi(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void sti(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void fork_i(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void lld(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void lldi(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void lfork(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
void aff(t_process *pro, t_arena *ar, t_instr_ret *ret, char verbose);
...
extern void (*g_instrs_f[NB_OPS])(t_process *proc, t_arena *arena, t_instr_ret *ret, char verbose);
/*
**  CHECK_COR
*/
